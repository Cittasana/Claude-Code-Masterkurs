...
// ========================================
  ...
  // ========================================
  // LEKTION 30 QUIZ — Voice Mode & Code Review Tool
  // ========================================
  {
    id: 'quiz-30',
    lessonId: 30,
    ...
    questions: [
      {
        id: 'q30-1',
        text: 'Wie wird Voice Mode in Claude Code aktiviert und wie funktioniert die Interaktion?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Always-On Listening sobald Claude Code startet', value: 'always' },
          { id: 'b', label: 'Über /voice aktivieren und per Push-to-Talk (Standard: Leertaste halten) sprechen', value: 'ptt', isCorrect: true },
          { id: 'c', label: 'Automatisch nach 5 Sekunden Inaktivität', value: 'idle' },
          { id: 'd', label: 'Nur über das Voice-Symbol in der GUI', value: 'gui' },
        ],
        correctAnswer: 'b',
        explanation: 'Laut Abschnitt "Voice Mode aktivieren und starten" wird Voice Mode über /voice gestartet. Push-to-Talk ist bewusst gewählt — du hältst die Leertaste, sprichst, lässt los. Kein Always-On, kein Datenschutz-Risiko.',
        hints: ['Slash-Befehl', 'Push-to-Talk, kein Always-On'],
      },
      {
        id: 'q30-2',
        text: 'Wo passt du den Push-to-Talk Hotkey an, falls die Leertaste unpraktisch ist?',
        type: 'radio',
        options: [
          { id: 'a', label: 'In ~/.claude/settings.json unter "voice.key"', value: 'settings' },
          { id: 'b', label: 'In ~/.claude/keybindings.json über voice:pushToTalk', value: 'keybindings', isCorrect: true },
          { id: 'c', label: 'Über das macOS System-Einstellungen-Panel', value: 'macos' },
          { id: 'd', label: 'Der Hotkey ist hardcoded und nicht änderbar', value: 'fixed' },
        ],
        correctAnswer: 'b',
        explanation: 'Im Abschnitt "Push-to-Talk Keybinding anpassen" steht: die Datei ~/.claude/keybindings.json mit dem Key "voice:pushToTalk" — Beispiele wie "meta+k" oder "ctrl+space" sind im Code-Block dokumentiert.',
        hints: ['Eigene Datei für Keybindings', 'Nicht settings.json'],
      },
      {
        id: 'q30-3',
        text: 'Welche Aufgabe ist laut Lektion ideal für Voice Mode, welche eher nicht?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Ideal: exakte Dateipfade diktieren — schlecht: lange Feature-Beschreibungen', value: 'reverse' },
          { id: 'b', label: 'Ideal: komplexe Anweisungen / Pair-Programming / Brainstorming — schlecht: exakte Pfade, Code-Snippets, kurze Befehle', value: 'voice', isCorrect: true },
          { id: 'c', label: 'Ideal: alles — Voice Mode ist universell besser', value: 'all' },
          { id: 'd', label: 'Ideal: nur Code-Snippets diktieren', value: 'snippets' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Voice Mode im Arbeitsalltag" listet beide Seiten: Ideal für komplexe natürlichsprachliche Anweisungen und Pair-Programming; weniger geeignet für exakte Pfade, Syntax-Snippets, kurze Befehle wie /clear oder im Großraumbüro.',
        hints: ['Natürliche Sprache vs. präzise Syntax', 'Faustregel im Text'],
      },
      {
        id: 'q30-4',
        text: 'Welche Reviewkategorien prüft das Code Review Tool laut Lektion?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Nur Security und Performance', value: 'two' },
          { id: 'b', label: 'Nur Stil und Formatierung', value: 'style' },
          { id: 'c', label: 'Security, Performance, Architektur, Bug-Potenzial, Wartbarkeit', value: 'five', isCorrect: true },
          { id: 'd', label: 'Nur Tests und Coverage', value: 'tests' },
        ],
        correctAnswer: 'c',
        explanation: 'Der Code-Block "CODE REVIEW KATEGORIEN" zählt explizit fünf Dimensionen auf: Security, Performance, Architektur, Bug-Potenzial, Wartbarkeit. Style-Hinweise sind bewusst nicht im Fokus.',
        hints: ['Fünf Buckets im Cheat-Sheet', 'Nicht Style-only'],
      },
      {
        id: 'q30-5',
        text: 'Warum nutzt das "Four Eyes Principle mit KI" /clear oder einen Subagent vor dem Review?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Weil Claude in derselben Session den eigenen Code positiver bewertet — frischer Kontext ist objektiver', value: 'objective', isCorrect: true },
          { id: 'b', label: 'Weil /clear automatisch alle Bugs findet', value: 'auto' },
          { id: 'c', label: 'Weil sonst die Tests fehlschlagen', value: 'tests' },
          { id: 'd', label: 'Weil das CLI ohne /clear keinen Review-Befehl akzeptiert', value: 'cli' },
        ],
        correctAnswer: 'a',
        explanation: 'Im Abschnitt "Review von KI-generiertem Code" steht wörtlich: in derselben Session bewertet Claude den eigenen Code tendenziell positiver. Frischer Kontext (via /clear oder Subagent) liefert die objektive Zweit-Perspektive.',
        hints: ['Bias-Argument', 'Eigener Code wird milder bewertet'],
      },
      {
        id: 'q30-6',
        text: 'In welchem Modus läuft Claude Code, wenn das Review als GitHub Action automatisiert werden soll?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Im Interactive-Modus mit TTY-Forwarding', value: 'tty' },
          { id: 'b', label: 'Im Headless-Modus über --print', value: 'print', isCorrect: true },
          { id: 'c', label: 'Im Daemon-Modus via systemd', value: 'daemon' },
          { id: 'd', label: 'In einem Docker-Container mit /voice aktiviert', value: 'docker' },
        ],
        correctAnswer: 'b',
        explanation: 'Im Abschnitt "Review in CI/CD integrieren" zeigt das YAML-Beispiel den Aufruf `claude --print "..."` — das ist der Headless-Modus ohne interaktives Terminal, perfekt für GitHub Actions.',
        hints: ['Nicht-interaktiver Flag', '--print = Headless'],
      },
    ],
  },
  // ========================================
  // LEKTION 31 QUIZ — 1M Context Window & Context Management
  // ========================================
  {
    id: 'quiz-31',
    lessonId: 31,
    title: '1M Context Window & Context Management',
    type: 'multiple-choice',
    points: 100,
    passingScore: 60,
    maxAttempts: 3,
    questions: [
      {
        id: 'q31-1',
        text: 'Was bedeutet das 1M Token Context Window (GA seit März 2026) in der Praxis?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Ca. 750.000 Wörter / 30.000-50.000 Zeilen Code in einem Kontext', value: 'practical', isCorrect: true },
          { id: 'b', label: 'Exakt 1 Million Zeichen pro Datei', value: 'chars' },
          { id: 'c', label: 'Beta-Header zwingend, dedizierte Rate-Limits', value: 'beta' },
          { id: 'd', label: 'Nur für Claude Haiku verfügbar', value: 'haiku' },
        ],
        correctAnswer: 'a',
        explanation: 'Der Abschnitt "Das 1M Token Context Window" sagt explizit: ~750.000 Wörter oder 30.000-50.000 Zeilen Code. GA bedeutet **ohne** Beta-Header und **ohne** dedizierte Rate-Limits.',
        hints: ['Faustregel im Text', 'GA = General Availability'],
      },
      {
        id: 'q31-2',
        text: 'Ab welcher Auslastung empfiehlt die Lektion proaktiv /compact?',
        type: 'radio',
        options: [
          { id: 'a', label: '~30%', value: '30' },
          { id: 'b', label: 'Erst bei 95%, wenn Claude Fehler macht', value: '95' },
          { id: 'c', label: 'Bei ~70% proaktiv, nicht erst bei 90%+', value: '70', isCorrect: true },
          { id: 'd', label: 'Nur wenn die Statuszeile rot ist', value: 'red' },
        ],
        correctAnswer: 'c',
        explanation: 'Die Profi-Tipps im "Context-Hygiene Cheat Sheet" und der Antipattern-Abschnitt sagen: /compact bei ~70% proaktiv. Ab 90% degradiert Claudes Performance messbar.',
        hints: ['Proaktiv statt reaktiv', 'Faustregel-Box am Ende'],
      },
      {
        id: 'q31-3',
        text: 'Warum sparen Subagents bis zu ~97% Context gegenüber direktem Datei-Lesen?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Sie lesen schneller und cachen den Output', value: 'cache' },
          { id: 'b', label: 'Sie laufen in einem eigenen Context Window — nur ihre Zusammenfassung landet in deinem Kontext', value: 'own', isCorrect: true },
          { id: 'c', label: 'Sie nutzen automatisch ein billigeres Modell', value: 'cheap' },
          { id: 'd', label: 'Sie löschen Dateien nach dem Lesen', value: 'delete' },
        ],
        correctAnswer: 'b',
        explanation: 'Im Block "SUBAGENT ALS CONTEXT-ENTLASTUNG" steht: der Subagent liest 15 Dateien in SEINEM Kontext, nur die ~500-Token-Zusammenfassung landet in DEINEM Kontext — von 25.500 auf 600 Tokens.',
        hints: ['Eigenes Context Window', 'Nur die Zusammenfassung zählt'],
      },
      {
        id: 'q31-4',
        text: 'Wann ist /clear besser geeignet als /compact?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Wenn du noch am gleichen Thema arbeitest', value: 'same' },
          { id: 'b', label: 'Wenn du eine komplett neue Aufgabe beginnst oder Claude 2× denselben Fehler macht', value: 'new', isCorrect: true },
          { id: 'c', label: 'Wenn der Kontext unter 30% ist', value: 'low' },
          { id: 'd', label: 'Niemals — /compact ist immer besser', value: 'never' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Entscheidungsbaum "/compact vs. /clear" sagt: bei neuer Aufgabe oder bei festgefahrenem Claude (2× gleicher Fehler) → /clear. /compact behält Kontext-Bezug, /clear startet sauber.',
        hints: ['Topic-Wechsel', 'Festgefahrener Loop'],
      },
      {
        id: 'q31-5',
        text: 'Wofür ist der PostCompact-Hook (seit März 2026) gut?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Er triggert /compact automatisch alle 30 Minuten', value: 'auto' },
          { id: 'b', label: 'Er löscht die Konversation komplett nach Compaction', value: 'delete' },
          { id: 'c', label: 'Er feuert nach einer Kompression — gut für Logging, Notifications und das Tracken der Compaction-Häufigkeit', value: 'after', isCorrect: true },
          { id: 'd', label: 'Er ersetzt /compact durch ein UI-Tool', value: 'ui' },
        ],
        correctAnswer: 'c',
        explanation: 'Strategie 5 ("PostCompact Hook") zeigt: der Hook feuert NACH der Kompression. Anwendungsfälle sind Logging in ~/.claude/compact.log und Desktop-Notifications, damit du bemerkst, dass möglicherweise Details verloren gingen.',
        hints: ['Event-Hook', 'Logging-/Notification-Pattern'],
      },
      {
        id: 'q31-6',
        text: 'Wie sieht eine context-effiziente CLAUDE.md laut Lektion aus?',
        type: 'radio',
        options: [
          { id: 'a', label: '300+ Zeilen mit Projektgeschichte, Team-Infos und Changelog', value: 'long' },
          { id: 'b', label: '≤100 Zeilen mit Tech Stack, Regeln, Befehlen und @imports für Detail-Dateien', value: 'lean', isCorrect: true },
          { id: 'c', label: 'Komplett leer — Claude soll alles selbst herausfinden', value: 'empty' },
          { id: 'd', label: 'Mindestens 500 Zeilen, damit Claude nichts vergisst', value: 'huge' },
        ],
        correctAnswer: 'b',
        explanation: 'Strategie 2 ("CLAUDE.md-Optimierung") und die Zusammenfassung am Ende empfehlen: ≤100 Zeilen Root-CLAUDE.md, nur Regeln/Konventionen/Befehle, Details via @imports (Progressive Disclosure).',
        hints: ['Faustregel: würde Claude ohne diese Zeile Fehler machen?', 'Progressive Disclosure'],
      },
    ],
  },
  // ========================================
  // LEKTION 44 QUIZ — Advisor Tool
  // ========================================
  {
    id: 'quiz-44',
    lessonId: 44,
    title: 'Advisor Tool — Cost-Aware Multi-Model',
    type: 'multiple-choice',
    points: 100,
    passingScore: 60,
    maxAttempts: 3,
    questions: [
      {
        id: 'q44-1',
        text: 'Wie ist die Rollenverteilung im Advisor-Tool-Pattern?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Teurer Executor (Opus) konsultiert günstigen Advisor (Haiku)', value: 'reverse' },
          { id: 'b', label: 'Günstiger Executor (Haiku) konsultiert teuren Advisor (Opus) nur bei schwerem Reasoning', value: 'correct', isCorrect: true },
          { id: 'c', label: 'Zwei gleiche Modelle stimmen ab', value: 'vote' },
          { id: 'd', label: 'Der User entscheidet pro Turn, welches Modell antwortet', value: 'manual' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Warum Advisor Tool jetzt?" beschreibt das Pattern klar: günstiger Executor fährt die Conversation, eskaliert nur die schweren Reasoning-Blocks an den teuren Advisor.',
        hints: ['Cost-Aware Multi-Model', 'Eskalation nur bei Bedarf'],
      },
      {
        id: 'q44-2',
        text: 'Was zeigen die Mai-2026-Benchmarks für Haiku + Opus-Advisor auf BrowseComp?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Score steigt von 19.7% auf 41.2% bei -85% Kosten vs. Solo-Sonnet', value: 'double', isCorrect: true },
          { id: 'b', label: 'Score fällt um 30%, dafür 90% billiger', value: 'fall' },
          { id: 'c', label: 'Keine messbare Veränderung', value: 'flat' },
          { id: 'd', label: 'Nur Kostenersparnis, keine Qualitätsverbesserung', value: 'cost-only' },
        ],
        correctAnswer: 'a',
        explanation: 'Die Benchmark-Tabelle im Abschnitt "Die offiziellen Anthropic-Benchmarks" zeigt: Haiku Solo 19.7%, Haiku + Opus-Advisor 41.2% (≈ Verdopplung / +21pp) und -85% Kosten gegenüber Solo-Sonnet.',
        hints: ['+21pp', 'Verdopplung'],
      },
      {
        id: 'q44-3',
        text: 'Welches Konfigurations-Snippet ist die richtige Production-Variante?',
        type: 'radio',
        options: [
          { id: 'a', label: '`tools=[{"type": "advisor_20260301", "advisor_model": "claude-opus-4-7", "max_advisor_spend_usd": 0.50}]` plus Beta-Header `advisor-tool-2026-03-01`', value: 'right', isCorrect: true },
          { id: 'b', label: 'Nur `extra_headers={"anthropic-beta": "advisor-tool-2026-03-01"}` ohne tools-Block', value: 'header-only' },
          { id: 'c', label: 'Ein eigener API-Endpoint /advisor statt messages.create', value: 'endpoint' },
          { id: 'd', label: 'Kein Tool-Block — der Advisor wird per System-Prompt aktiviert', value: 'prompt' },
        ],
        correctAnswer: 'a',
        explanation: 'Das Production-Snippet im Abschnitt "Production-Konfiguration" zeigt exakt diesen Aufbau: Beta-Header + Tool-Deklaration mit type `advisor_20260301`, advisor_model und einem hartem `max_advisor_spend_usd`-Cap.',
        hints: ['Beta-Header und Tool-Block zusammen', 'Cap nicht vergessen'],
      },
      {
        id: 'q44-4',
        text: 'Was passiert, wenn `max_advisor_spend_usd` während eines Requests erschöpft ist?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Der Request bricht mit einem Error ab', value: 'error' },
          { id: 'b', label: 'Anthropic stellt zusätzliche Tokens in Rechnung', value: 'overage' },
          { id: 'c', label: 'Der Executor läuft still ohne weitere Advisor-Aufrufe weiter', value: 'silent', isCorrect: true },
          { id: 'd', label: 'Der Beta-Header wird ignoriert und Sonnet übernimmt', value: 'sonnet' },
        ],
        correctAnswer: 'c',
        explanation: 'Im erläuternden Text nach dem Production-Snippet steht wörtlich: bei Erschöpfung "fehlt der Advisor still — die Conversation läuft weiter, du bekommst keinen Error". Das macht das Pattern produktionstauglich.',
        hints: ['Worst-Case-Cost begrenzt', 'Kein Error, sondern silent fallback'],
      },
      {
        id: 'q44-5',
        text: 'Wann ist Advisor Tool laut Lektion KEINE gute Wahl?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Bei Backend-Agents und Cron-Jobs', value: 'backend' },
          { id: 'b', label: 'Bei Streaming-UI mit harten Latenz-SLOs (< 500ms TTFT) und bei trivialem Boilerplate', value: 'latency', isCorrect: true },
          { id: 'c', label: 'Bei Coding-Agents mit Multi-Step-Refactors', value: 'coding' },
          { id: 'd', label: 'Bei Research-Agents mit Web-Search', value: 'research' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Wann KEIN Advisor Tool" nennt drei klare Antipatterns: Streaming-UI mit Latenz-SLOs (1-3s extra Latenz pro Advisor-Roundtrip), triviale Conversations und Realtime-Tool-Use.',
        hints: ['Roundtrip kostet Sekunden', 'Streaming kollidiert'],
      },
      {
        id: 'q44-6',
        text: 'Wie verhält sich das Advisor Tool zu Cursor `/multitask` und Copilot Rubber-Duck?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Sie sind identisch in der Architektur', value: 'same' },
          { id: 'b', label: 'Advisor Tool ersetzt beide vollständig', value: 'replace' },
          { id: 'c', label: 'Die Patterns sind komplementär: Advisor für Cost-Optimization, /multitask für parallele Feature-Builds, Rubber-Duck für Quality-Check', value: 'complement', isCorrect: true },
          { id: 'd', label: 'Nur Cursor unterstützt Multi-Model', value: 'only-cursor' },
        ],
        correctAnswer: 'c',
        explanation: 'Die Vergleichstabelle und der Folgesatz "Die Patterns sind komplementär, nicht konkurrierend" im Abschnitt "Vergleich: Anthropic Advisor vs. Cursor /multitask vs. Copilot Rubber-Duck" stellen die unterschiedlichen Domänen klar.',
        hints: ['Drei Vendor, drei Domänen', 'Komplementär'],
      },
    ],
  },
  // ========================================
  // LEKTION 45 QUIZ — worktree.baseRef
  // ========================================
  {
    id: 'quiz-45',
    lessonId: 45,
    title: 'worktree.baseRef — Multi-Agent-Worktrees',
    type: 'multiple-choice',
    points: 100,
    passingScore: 60,
    maxAttempts: 3,
    questions: [
      {
        id: 'q45-1',
        text: 'Wie sieht die Default-History von `worktree.baseRef` aus?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Bis 2.1.127 head, ab 2.1.128 fresh, ab 2.1.133 wieder head', value: 'wrong' },
          { id: 'b', label: 'Bis 2.1.127 fresh, 2.1.128-2.1.132 head (still), ab 2.1.133 fresh (explizit)', value: 'right', isCorrect: true },
          { id: 'c', label: 'Immer fresh — kein Wechsel', value: 'always-fresh' },
          { id: 'd', label: 'Immer head — kein Wechsel', value: 'always-head' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Highlight-Block "Default-Wechsel-Timeline" listet exakt diese drei Phasen: bis 2.1.127 fresh, 2.1.128–2.1.132 stiller Wechsel auf head, ab 2.1.133 wieder fresh als Default.',
        hints: ['Drei Phasen', 'Stiller Wechsel in 2.1.128'],
      },
      {
        id: 'q45-2',
        text: 'Was bedeutet `worktree.baseRef: "fresh"` konkret?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Neuer Worktree branched aus origin/<default-branch>', value: 'origin', isCorrect: true },
          { id: 'b', label: 'Neuer Worktree branched aus deinem lokalen HEAD inklusive unpushed Commits', value: 'head' },
          { id: 'c', label: 'Neuer Worktree wird komplett ohne Branch erstellt', value: 'detached' },
          { id: 'd', label: 'Bestehende Worktrees werden gelöscht', value: 'delete' },
        ],
        correctAnswer: 'a',
        explanation: 'Der Abschnitt "Die zwei Modi: fresh vs. head" definiert: `fresh` → branched aus `origin/<default-branch>`. Use-Case: Workshops, CI, saubere Sub-Agents.',
        hints: ['origin = fresh', 'Sauberer Startpunkt'],
      },
      {
        id: 'q45-3',
        text: 'Welche Best Practice nennt die Lektion für die Konfiguration?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Den Default nie überschreiben — Anthropic weiß es am besten', value: 'default' },
          { id: 'b', label: 'Den Wert immer **explizit** in settings.json setzen, auch wenn er dem aktuellen Default entspricht', value: 'explicit', isCorrect: true },
          { id: 'c', label: 'Vor jedem Worktree-Befehl per CLI-Flag setzen', value: 'cli-flag' },
          { id: 'd', label: 'Den Default per git-Hook erzwingen', value: 'git-hook' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Highlight "Best Practice" sagt direkt: explizit setzen, auch wenn der Default deine Wahl ist — damit bist du unabhängig von zukünftigen Default-Wechseln und dokumentierst die Intent.',
        hints: ['Schutz vor zukünftigem Default-Wechsel', 'Intent dokumentieren'],
      },
      {
        id: 'q45-4',
        text: 'Welcher Pre-Update-Check zeigt potenzielles Daten-Risiko?',
        type: 'radio',
        options: [
          { id: 'a', label: '`git status` reicht aus', value: 'status' },
          { id: 'b', label: '`git log origin/main..HEAD` zeigt unpushed Commits, auf denen Sub-Agents seit 2.1.128 unbemerkt aufgesetzt haben könnten', value: 'log', isCorrect: true },
          { id: 'c', label: '`git remote -v`', value: 'remote' },
          { id: 'd', label: '`git stash list`', value: 'stash' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Pre-Update-Check-Code-Block zeigt `git log origin/main..HEAD` als zweiten Befehl: wenn Output kommt, hat dein Sub-Agent unter 2.1.128 stillschweigend auf diesen unpushed Commits aufgesetzt.',
        hints: ['Unpushed vs. origin', 'Befehl aus dem Check-Block'],
      },
      {
        id: 'q45-5',
        text: 'In Szenario 2 (Daily Driver mit lokalen Feature-Branches): wie migrierst du nach 2.1.133+?',
        type: 'radio',
        options: [
          { id: 'a', label: '`baseRef: "fresh"` setzen, weil das der neue Default ist', value: 'fresh' },
          { id: 'b', label: '`baseRef: "head"` explizit setzen, um das bisherige 2.1.128-Pattern beizubehalten', value: 'head', isCorrect: true },
          { id: 'c', label: 'Auf 2.1.127 zurück downgraden', value: 'downgrade' },
          { id: 'd', label: 'Alle Worktrees löschen und neu erstellen', value: 'recreate' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Migrations-Szenarien-Block sagt für Szenario 2 wörtlich: "Update auf 2.1.133+, setze baseRef: head explizit — dein Pattern bleibt erhalten." Sub-Agents bauen weiter auf unpushed Commits auf.',
        hints: ['Sub-Agent auf laufender Feature-Arbeit', 'Pattern beibehalten'],
      },
    ],
  },
  // ========================================
  // LEKTION 46 QUIZ — Effort-aware Hooks
  // ========================================
  {
    id: 'quiz-46',
    lessonId: 46,
    title: 'Effort-aware Hooks',
    type: 'multiple-choice',
    points: 100,
    passingScore: 60,
    maxAttempts: 3,
    questions: [
      {
        id: 'q46-1',
        text: 'Welche Env-Variable bringt seit Claude Code 2.1.133 den aktuellen Effort-Level in deinen Hook?',
        type: 'radio',
        options: [
          { id: 'a', label: '$CLAUDE_LEVEL', value: 'level' },
          { id: 'b', label: '$CLAUDE_EFFORT', value: 'effort', isCorrect: true },
          { id: 'c', label: '$EFFORT_LEVEL', value: 'effort-level' },
          { id: 'd', label: '$ANTHROPIC_EFFORT', value: 'anthropic' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Warum Effort-aware Hooks?" nennt explizit `$CLAUDE_EFFORT` als neue Env-Variable seit 2.1.133. Im JSON-Hook-Input gibt es zusätzlich das Feld `effort.level`.',
        hints: ['CLAUDE_ Prefix', 'EFFORT statt LEVEL'],
      },
      {
        id: 'q46-2',
        text: 'Welche vier Effort-Levels gibt es laut Lektion und welche Quality-Gates passen je Level?',
        type: 'radio',
        options: [
          { id: 'a', label: 'off / on — Lint vs. Full Suite', value: 'binary' },
          { id: 'b', label: 'low / medium / high / xhigh — Lint, +Type-Check, +Tests, +E2E', value: 'four', isCorrect: true },
          { id: 'c', label: 'fast / safe / strict / paranoid', value: 'wrong-names' },
          { id: 'd', label: '1 / 2 / 3 / 4 — nur numerisch', value: 'numeric' },
        ],
        correctAnswer: 'b',
        explanation: 'Die Mapping-Tabelle "Die vier Effort-Levels" zeigt die vier Stufen `low`, `medium`, `high`, `xhigh` (xhigh neu mit Opus 4.7) mit gestaffelter Gate-Empfehlung: Lint → +Type-Check → +Unit-Tests → +E2E.',
        hints: ['Vier, nicht zwei', 'xhigh kam mit Opus 4.7'],
      },
      {
        id: 'q46-3',
        text: 'Welches Code-Pattern ist das **richtige** Effort-aware Pattern?',
        type: 'radio',
        options: [
          { id: 'a', label: '`if [ "$CLAUDE_EFFORT" = "high" ] || [ "$CLAUDE_EFFORT" = "xhigh" ]; then npm test; else npm run lint; fi`', value: 'boolean' },
          { id: 'b', label: '`case "$CLAUDE_EFFORT" in low) ... ;; medium) ... ;; high) ... ;; xhigh) ... ;; esac` mit vier unterschiedlichen Gates', value: 'case', isCorrect: true },
          { id: 'c', label: 'Komplett ignorieren und immer die Full Suite laufen lassen', value: 'always' },
          { id: 'd', label: 'Den Hook nur bei `xhigh` registrieren, sonst gar nicht', value: 'register' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Antipattern-Abschnitt zeigt das `if`-Pattern als FALSCH ("Effort als Boolean") und das `case`-Pattern mit vier Branches als KORREKT. Die Granularität von vier Stufen darf nicht auf zwei kollabiert werden.',
        hints: ['Vier Branches', 'case statt if'],
      },
      {
        id: 'q46-4',
        text: 'Wie sieht der strukturierte Zugriff im JSON-Hook-Input aus?',
        type: 'radio',
        options: [
          { id: 'a', label: '`${effort.level}` als Template-Variable in der Hook-Command', value: 'template', isCorrect: true },
          { id: 'b', label: '`{{ EFFORT }}` Mustache-Syntax', value: 'mustache' },
          { id: 'c', label: '`%CLAUDE_EFFORT%` Windows-Style', value: 'windows' },
          { id: 'd', label: 'JSON-Input enthält keinen Effort — nur die Env-Variable', value: 'env-only' },
        ],
        correctAnswer: 'a',
        explanation: 'Der Abschnitt "JSON-Input mit ${effort.level}" zeigt die Template-Variable in einem Command wie `python ~/.claude/scripts/quality_gate.py --effort ${effort.level} --file ${file_path}`.',
        hints: ['Template-Variable mit Dollar-Brace', 'effort.level'],
      },
      {
        id: 'q46-5',
        text: 'Welches Production-Setup empfehlen die Mai-2026-Best-Practices?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Nur Effort-aware Hooks, kein hard_deny', value: 'hooks-only' },
          { id: 'b', label: 'hard_deny + $defaults + Effort-aware Hooks zusammen — Quality dynamisch nach oben, Sicherheits-Notbremse nach unten', value: 'combined', isCorrect: true },
          { id: 'c', label: 'Nur hard_deny mit komplett deaktivierter Auto-Mode', value: 'deny-only' },
          { id: 'd', label: 'Keine Hooks, alles per Prompt regeln', value: 'prompt' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Kombination mit hard_deny" zeigt das vollständige Production-Setup: `autoMode.hard_deny` als Notbremse, `$defaults` für minimalen Config-Overhead und der Effort-aware Hook für dynamische Quality-Gates.',
        hints: ['Drei Bausteine', 'Determinismus aus zwei Richtungen'],
      },
    ],
  },
  // ========================================
  // LEKTION 47 QUIZ — Multi-Agent Showdown
  // ========================================
  {
    id: 'quiz-47',
    lessonId: 47,
    ...
    questions: [
      {
        id: 'q47-1',
        text: 'Welches Multi-Agent-Primitive nutzt Claude Code?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Async Dispatch über einen "Build in Parallel"-Button', value: 'cursor' },
          { id: 'b', label: 'Hierarchische Goal-Trees mit Pfad-Adressen wie /root/agent_a', value: 'codex' },
          { id: 'c', label: 'Explizite Git-Worktrees pro Task — User orchestriert', value: 'worktrees', isCorrect: true },
          { id: 'd', label: 'Voice-gesteuerte Subagent-Spawnung', value: 'voice' },
        ],
        correctAnswer: 'c',
        explanation: 'Der Abschnitt "1. Claude Code — Worktree-Pattern" beschreibt: Claude Code organisiert Multi-Agent explizit über Git-Worktrees. Du erstellst pro Task einen isolierten Worktree und merged das Ergebnis zurück.',
        hints: ['Power-User-Pattern', 'Filesystem-Isolation'],
      },
      {
        id: 'q47-2',
        text: 'Welche UX-Funktion ist exklusiv bei Cursor 3.3?',
        type: 'radio',
        options: [
          { id: 'a', label: '/multitask + Build in Parallel mit Auto-PR-Split', value: 'multitask', isCorrect: true },
          { id: 'b', label: 'worktree.baseRef-Konfiguration', value: 'baseref' },
          { id: 'c', label: '/goal create für persistierte Sessions', value: 'goal' },
          { id: 'd', label: 'Cross-Family-Critic', value: 'critic' },
        ],
        correctAnswer: 'a',
        explanation: 'Der Abschnitt "2. Cursor — /multitask + Build in Parallel (Editor-UX)" und die Vergleichstabelle zeigen: Auto-PR-Split ist Cursor-exklusiv (⭐⭐⭐⭐⭐), Claude Code und Codex haben das nicht.',
        hints: ['Editor-UX', 'Auto-Split der PRs'],
      },
      {
        id: 'q47-3',
        text: 'Welches Feature hat Codex CLI 0.130 (Mai 2026), das Claude Code nativ NICHT hat?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Worktrees', value: 'worktrees' },
          { id: 'b', label: 'Headless-Mode', value: 'headless' },
          { id: 'c', label: 'Persistierte sessionsübergreifende Goal-Trees mit Pfad-Adressen wie /root/agent_a', value: 'goal', isCorrect: true },
          { id: 'd', label: 'Hooks', value: 'hooks' },
        ],
        correctAnswer: 'c',
        explanation: 'Der Abschnitt "3. Codex CLI — Hierarchische Goal-Trees" sagt: "Persistierte Goals — eine der wenigen Features, die Claude Code nicht hat (kein nativ sessionsübergreifendes Task-Tracking ohne Skill/Plugin)."',
        hints: ['Sessions überleben', 'Hierarchische Pfad-Adressen'],
      },
      {
        id: 'q47-4',
        text: 'Welches universelle Pattern teilen laut Lektion alle vier Vendor (Claude Code, Cursor, Codex, Copilot)?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Sie laufen alle headless im selben CLI', value: 'cli' },
          { id: 'b', label: 'Sie nutzen alle isolierte Workspaces / Worktrees als Multi-Agent-Substrat, plus Plan-First-Dispatch und Budget-Caps', value: 'worktree-substrat', isCorrect: true },
          { id: 'c', label: 'Sie haben alle einen "Build in Parallel"-Button', value: 'button' },
          { id: 'd', label: 'Sie nutzen alle dieselben Modelle', value: 'models' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Abschnitt "Universelle Patterns" listet als Substrat-Pattern: Claude Code (explizit), Cursor (intern), Codex (per Goal-Config), Copilot (über VS-Code-Workspaces) — alle vier nutzen isolierte Workspaces. Plus Plan-First, Snapshots, Budget-Awareness.',
        hints: ['Verborgene Standardisierung', 'Plan-First + Budget-Cap'],
      },
      {
        id: 'q47-5',
        text: 'Welche Common-Mistakes-Faustregel nennt die Lektion zu Multi-Agent-Speed?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Mehr Agents sind immer schneller', value: 'more' },
          { id: 'b', label: 'Wenn ein Task < 5 Minuten Solo dauert, lohnt Multi-Agent nicht — Pro-Agent-Overhead frisst den Speedup', value: '5min', isCorrect: true },
          { id: 'c', label: 'Maximal 2 Agents parallel, sonst stürzt das System ab', value: 'max-two' },
          { id: 'd', label: 'Sub-Agent-Tiefe von 5 ist ideal', value: 'depth-5' },
        ],
        correctAnswer: 'b',
        explanation: 'Der "Common Mistakes"-Abschnitt sagt wörtlich: "Multi-Agent ist kein Magic-Speed-Up. Pro-Agent-Overhead frisst Speedup, sobald Tasks zu klein werden. Faustregel: Wenn ein Task < 5 Minuten Solo dauert, lohnt Multi-Agent nicht."',
        hints: ['Overhead-Argument', '5-Minuten-Schwelle'],
      },
      {
        id: 'q47-6',
        text: 'Was ist laut Lektion die "ehrliche Antwort" auf die Frage, welches Tool das beste ist?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Claude Code ist objektiv überlegen', value: 'cc' },
          { id: 'b', label: 'Alle drei lösen identische Szenarien gleichwertig — die Wahl ist eine UX- und Workflow-Frage, keine Capability-Frage', value: 'equal', isCorrect: true },
          { id: 'c', label: 'Codex CLI gewinnt bei jedem Benchmark', value: 'codex' },
          { id: 'd', label: 'Es kommt nur auf das Preismodell an', value: 'price' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Highlight-Block "Die ehrliche Antwort" nach dem Mini-Hands-On sagt klar: "Alle drei lösen das Szenario gleichwertig. Die Wahl ist eine UX- und Workflow-Frage — nicht eine Capability-Frage."',
        hints: ['UX-Frage statt Capability-Frage', 'Vier Stunden bleiben vier Stunden'],
      },
    ],
  },
  // ========================================
  // LEKTION 48 QUIZ — Skill-Antipatterns
  // ========================================
  {
    id: 'quiz-48',
    lessonId: 48,
    title: 'Skill-Antipatterns',
    type: 'multiple-choice',
    points: 100,
    passingScore: 60,
    maxAttempts: 3,
    questions: [
      {
        id: 'q48-1',
        text: 'Welche drei Antipatterns nennt die Lektion?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Mega-Skill, Kitchen-Sink-Session, Day-One-Hoarding', value: 'right', isCorrect: true },
          { id: 'b', label: 'Slow-Skill, Empty-Session, Tool-Diet', value: 'wrong' },
          { id: 'c', label: 'YAML-Hoarding, Voice-Spam, Worktree-Chaos', value: 'distract' },
          { id: 'd', label: 'Compact-Overuse, Plugin-Drift, Hook-Loop', value: 'related' },
        ],
        correctAnswer: 'a',
        explanation: 'Der Titel und der Einleitungsabschnitt "Drei Antipatterns, immer wieder" benennen exakt diese drei: Mega-Skill, Kitchen-Sink-Session, Day-One-Hoarding.',
        hints: ['Drei Antipatterns im Titel', 'Skill, Session, Setup'],
      },
      {
        id: 'q48-2',
        text: 'Wie erkennst du laut Lektion einen Mega-Skill in deiner eigenen Description?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Wenn die Description länger als 100 Zeichen ist', value: 'length' },
          { id: 'b', label: 'Wenn die Description ein "und" enthält — sie verbindet mehrere Verantwortungen', value: 'und', isCorrect: true },
          { id: 'c', label: 'Wenn der Skill weniger als 3-mal pro Woche triggert', value: 'frequency' },
          { id: 'd', label: 'Wenn der Skill mehrere Sprachen unterstützt', value: 'i18n' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Highlight "Die Single-Responsibility-Regel" sagt wörtlich: "Ein Skill macht eine Sache. Wenn die Description ein \'und\' enthält, ist es ein Mega-Skill. Refactor zu zwei Skills."',
        hints: ['Ein-Wort-Hinweis', 'Single Responsibility'],
      },
      {
        id: 'q48-3',
        text: 'Welches Symptom deutet auf eine Kitchen-Sink-Session hin?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Claude zitiert plötzlich Code aus früheren, nicht mehr relevanten Dateien oder hallucinated Imports aus verlassenen Repos', value: 'symptoms', isCorrect: true },
          { id: 'b', label: 'Claude antwortet schneller als erwartet', value: 'fast' },
          { id: 'c', label: 'Voice Mode funktioniert nicht mehr', value: 'voice' },
          { id: 'd', label: 'Die CLAUDE.md wird größer', value: 'md' },
        ],
        correctAnswer: 'a',
        explanation: 'Die Symptom-Liste in Antipattern 2 zählt genau diese auf: Claude zitiert Code aus früheren Dateien, halluziniert Imports aus verlassenen Repos, Confusion zwischen Threads, häufige Compaction, langsame Antworten.',
        hints: ['Repo-Vermischung', 'Confusion zwischen Threads'],
      },
      {
        id: 'q48-4',
        text: 'Was ist der "First 30 Days Stack" gegen Day-One-Hoarding?',
        type: 'radio',
        options: [
          { id: 'a', label: '30 Skills aus dem Marketplace pro Tag installieren', value: 'install' },
          { id: 'b', label: 'Filesystem-MCP + Git-MCP, EIN Skill für deine Hauptaufgabe und eine CLAUDE.md mit < 200 Zeilen — vier Wochen lang nicht erweitern', value: 'stack', isCorrect: true },
          { id: 'c', label: 'Jeden Tag einen neuen MCP-Server testen', value: 'daily-mcp' },
          { id: 'd', label: 'Alle 80 Skills behalten, aber Tags vergeben', value: 'tags' },
        ],
        correctAnswer: 'b',
        explanation: 'Die Fix-Liste in Antipattern 3 nennt den Stack: Filesystem-MCP + Git-MCP, EIN Skill für die Hauptaufgabe, CLAUDE.md mit < 200 Zeilen. Erweitern erst nach 4 Wochen, wenn du das Setup ohne Nachdenken nutzt.',
        hints: ['Drei Tools, vier Wochen', 'Tiefe vor Breite'],
      },
      {
        id: 'q48-5',
        text: 'Was ist der gemeinsame Wurzel-Fehler aller drei Antipatterns?',
        type: 'radio',
        options: [
          { id: 'a', label: 'Zu wenig Tools — der User ist nicht ambitioniert genug', value: 'too-few' },
          { id: 'b', label: 'Zu viel Kontext gleichzeitig — pro Skill, pro Session, pro Setup', value: 'too-much', isCorrect: true },
          { id: 'c', label: 'Falsche Modell-Wahl', value: 'model' },
          { id: 'd', label: 'Veraltete Claude-Code-Version', value: 'version' },
        ],
        correctAnswer: 'b',
        explanation: 'Der Schlussabschnitt "Warum diese drei zusammen?" benennt den Wurzel-Fehler: "zu viel Kontext gleichzeitig" — Mega-Skill packt zu viel in einen Skill, Kitchen-Sink in eine Session, Day-One-Hoarding ins Setup. Fix: weniger pro Einheit, dafür schärfer.',
        hints: ['Drei Ebenen, ein Wurzel-Fehler', 'Single Responsibility / Single Theme / Three Tools'],
      },
    ],
  },
];
